    ...
    var o = n(0),
        ...
        x = function() {
            function t(e, n) {
                ...
                // this.useAjax = !d.a.isMobile(), this.initialized = !1, this.pages = {}, this.cache = {}, s()(document).on("click", "a[href]", this.handleLinkClick.bind(this)), s()(window).on("popstate", this.handleHistoryChange.bind(this))
            }
            return b(t, null, [{
                key: "Defaults",
                get: function() {
